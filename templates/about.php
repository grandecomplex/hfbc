...
<div class="sections">
  ...
  <div class="section">
    ...
    <div class="row-fluid">
      <div class="span6">
        <h3>Mission</h3>
        <p>Our mission is to empower people worldwide to take action and use their talents to affect change beginning in their communities. We inspire and empower them to make “big choices” - they have the power to change the world.</p>
        ...
        <p>We identify global problems that affect local countries, provide leadership, free education, build multidisciplinary teams, inspire creativity, and give the teams the platform to solve problems together.</p>
      </div>
      <div class="span6">
        <h3>Principles</h3>
  ...
  <div class="section">
    <div class="centered">
      <h2 class="section_title">Advisors</h2>
    </div>
    <div class="our_team_section speaker-wrapper circle-pic-list clearfix">
  ...
  <div class="row-fluid">
    <div class="span6">
      <h3>Hack for Big Choices- Hackathon</h3>
      ...
      <h3>Hack for Big Choices - Talks</h3>
...
<p> </p>
    ...
    <div class="span6">
      <h3>Hack for Big Choices- No Barriers</h3>
      ...
      <p>Lyte.io provides a smart team messaging platform that allows people to develop conversations around a common topic. </p>

      <p>DotSub distributes video in multiple languages and indexes online video content. </p>
      <p>For example, if one does a Google search for "accessible university in Ghana" one pulls up John Roberts' speech - he talks about how the idea to start the University of West Africa came about. Transcripts indexes the video in 13 languages.</p>

      <p>This unleashes an opportunity for all participants and partners to connect and learn from each other. </p>
      
      <h3>Hack for Big Choices- Make solve real problems</h3>
      ...
      <h3>Hack for Big Choices- Give Back</h3>
