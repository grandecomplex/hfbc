...
<div class="sections">
  ...
  <iframe width="100%" height="360" id="video" src="//www.youtube.com/embed/xoUfvIb-9U4?rel=0" frameborder="0" allowfullscreen></iframe>
      ...
      <div class="span5" itemscope itemtype="http://schema.org/Event">
        ...
        <ul class="datetime clearfix row-fluid">
          <li class="span6"><img alt="some_text" src="/media/cal.gif" /> <span class="title-font" itemprop="startDate">starting on October 5th, 2013</span></li>
  ...
  <div id="section4" class="centered section">
    <h2 id="locations" class="section_title">Locations</h2>
    <p class="subline">Hack for Big Choices will take place in 12 cities over 5 different continents.</p>
