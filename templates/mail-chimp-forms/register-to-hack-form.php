...
<option id="singapore-form" value="Singapore, Malaysia">Singapore</option>
...
<option id="sydney-form" value="Sydney, Australia">Sydney, Australia</option>
  ...
  <div class="button-wrapper">
    <input type="submit" value="Register To Hack" name="subscribe" id="mc-embedded-subscribe" class="button button-primary">
  </div>
</form>
</div>
