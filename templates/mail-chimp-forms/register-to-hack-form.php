...
<form action="http://hackforbigchoices.us7.list-manage1.com/subscribe/post?u=84324a24b8bb798baeadac59e&amp;id=39e42ac782" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate mc-embedded-subscribe-form" target="_blank" novalidate>
...
<div id="first-last-wrapper" class="clearfix">
  <div class="mc-field-group">
...
<div class="mc-field-group">
	<label for="mce-CITY">City
</label>
	<select name="CITY" class="required" id="mce-CITY">
	<option value=""></option>
...
<div class="mc-field-group input-group">
    ...
    <ul class="mc_list"><li><input type="radio" value="html" name="EMAILTYPE" id="mce-EMAILTYPE-0"><label for="mce-EMAILTYPE-0">html</label></li>
...
function mce_init_form(){
    jQuery(document).ready( function($) {
      ...
      options = { url: 'http://hackforbigchoices.us7.list-manage.com/subscribe/post-json?u=84324a24b8bb798baeadac59e&id=39e42ac782&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
